...
- HTML export: URL state now persists tree selection (`leafId`), filter mode (`filter`), and target message (`targetId`), enabling shareable links to specific branches with display settings
